...
/**
 * An {@link CustomImageRegion} defines an area of an image buffer in terms of either a typical
 ...
 * of the image buffer.
 */
public class CustomImageRegion
{
     ...
     */
    private CustomImageRegion(boolean imageCoords, double left, double top, double right, double bottom )
    {
        this.left = left;
        this.top = top;
        this.right = right;
    ...
    /**
     * Construct an {@link CustomImageRegion} using typical image processing coordinates
     *
     *  --------------------------------------------
     *  | (0,0)-------X                            |
     *  |  |                                       |
     ...
     * @return an {@link CustomImageRegion} object describing the region
     */
    public static CustomImageRegion asImageCoordinates(int left, int top, int right, int bottom )
    {
        return new CustomImageRegion(true, left, top, right, bottom);
    }

    /**
     * Construct an {@link CustomImageRegion} using "Unity Center" coordinates
     *
     *  --------------------------------------------
     *  | (-1,1)             Y               (1,1) |
     *  |                    |                     |
     ...
     * @return an {@link CustomImageRegion} object describing the region
     */
    public static CustomImageRegion asUnityCenterCoordinates(double left, double top, double right, double bottom)
    {
        return new CustomImageRegion(false, left, top, right, bottom);
    }

    /**
     * Construct an {@link CustomImageRegion} representing the entire frame
     * @return an {@link CustomImageRegion} representing the entire frame
     */
    public static CustomImageRegion entireFrame()
    {
        return CustomImageRegion.asUnityCenterCoordinates(-1, 1, 1, -1);
    }

    /**
     * Create an OpenCV Rect object which is representative of this {@link CustomImageRegion}
